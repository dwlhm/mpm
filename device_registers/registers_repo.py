...
register_aw9l = [
	...
	[16390, 0.1, 'V', 'wire_voltage_ab'],
	[16392, 0.1, 'V', 'wire_voltage_bc'],
	[16394, 0.1, 'V', 'wire_voltage_ca'],
	[16396, 0.001, 'A', 'phase_current_a'],
	[16398, 0.001, 'A', 'phase_current_b'], 
	[16400, 0.001, 'A', 'phase_current_c'],
	[16402, 0.1, 'W', 'active_power_a'],
	[16404, 0.1, 'W', 'active_power_b'],
	[16406, 0.1, 'W', 'active_power_c'],
	[16410, 0.1, 'var', 'reactive_power_a'],
	[16412, 0.1, 'var', 'reactive_power_b'],
	[16414, 0.1, 'var', 'reactive_power_c'],
	[16418, 0.1, 'VA', 'apparent_power_a'],
	[16420, 0.1, 'VA', 'apparent_power_b'],
	[16422, 0.1, 'VA', 'apparent_power_c'],
	[16426, 0.001, '', 'power_factor_a'],
	[16428, 0.001, '', 'power_factor_b'],
	[16430, 0.001, '', 'power_factor_c'],
	[16434, 0.01, 'Hz', 'frequency'],
	[16436, 0.001, 'kWh', 'active_power'],
	[16438, 0.001, 'kvarh', 'reactive_power'],
	[16440, 0.001, 'kWh', 'positive_active_power'],
	[16442, 0.001, 'kWh', 'negative_active_power'],
	[16444, 0.001, 'kvarh', 'positive_reactive_power'], 
	[16446, 0.001, 'kvarh', 'negative_reactive_power'], 
	[16454, 0.1, 'W', 'current_active_power_demand'],
	[16456, 0.1, 'W', 'maximum_active_power_demand'],
	[16458, 0.1, 'kvar', 'current_reactive_power_demand'], 
	[16460, 0.1, 'kvar', 'maximum_reactive_power_demand'],
	[16466, 0.1, '%', 'a_phase_voltage_total_harmonic_content'],
	[16468, 0.1, '%', 'b_phase_voltage_total_harmonic_content'],
	[16470, 0.1, '%', 'c_phase_voltage_total_harmonic_content'],
	[16472, 0.1, '%', 'a_phase_current_total_harmonic_content'],
	[16474, 0.1, '%', 'b_phase_current_total_harmonic_content'],
	...
	[16500, 0.001, 'kvarh', 'third_quadrant_reactive_energy'],
	[16502, 0.001, 'kvarh', 'fourth_quadrant_reactive_power'],
]
